...
#' @details
#'
#' run_r_all executes all simulations of the specified NetLogo model within the provided nl object.
...
#' @details
#'
#' run_r_one executes one simulation of the specified NetLogo model within the provided nl object.
...
run_r_dyn <- function(nl,
  ...
  if (getsim(nl, "simmethod") == "GenSA") {
    nl_results <- util_run_r_dyn_GenSA(
      nl = nl,
      seed = seed,
      cleanup.csv = cleanup.csv,
      cleanup.xml = cleanup.xml,
  ...
  if (getsim(nl, "simmethod") == "GenAlg") {
    nl_results <- util_run_r_dyn_GenAlg(
      nl = nl,
      seed = seed,
      cleanup.csv = cleanup.csv,
      cleanup.xml = cleanup.xml,
  ...
  if (getsim(nl, "simmethod") == "ABCmcmc") {
    nl_results <- util_run_r_dyn_ABCmcmc(
      nl = nl,
      seed = seed,
      cleanup.csv = cleanup.csv,
      cleanup.xml = cleanup.xml,
